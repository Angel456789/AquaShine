...
$consulta = mysqli_query($conn, "SELECT * FROM servicio");
        ...
        <div class="listado">
            <table class="table table-responsive table-hover ">
                ...
                ?>
                    ...
                    <td><?= $nr['id']; ?></td>
                    <td><?= $nr['nombre']; ?></td>
                    <td><?= $nr['descripcion']; ?></td>
                    <td><?= $nr['precio']; ?></td>
                        <td><a class="edit" href="agregarServicio.php?id=<?= $nr['id'] ?>"><i class="fa-solid fa-pencil" ></i></a></td>
                        <td><a href="php/controlServicio.php?eliminar=<?=$nr['id'] ?>"><i class="fa-solid fa-trash"></i></a></td>
                    </tr>
                    <?php
                        $i++;
                        if ($i == 2) {
