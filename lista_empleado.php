...
$consulta = mysqli_query($conn, "SELECT * FROM empleado");
...
<body>
    ...
    <div class="container-fluid">
        <div class="nov">
            <h2>Empleados</h2>
            <h3>Nuevo empleado</h3><br>
            <a href="agregarEmpleado.html" style="left: 230px;">
            ...
            <table class="table table-responsive table-hover">
                ...
                <tbody class="table-group-divider">
                    <tr>
                        ...
                        <td><?= $nr['Salario']; ?></td>
                        <td><?= $nr['Correo']; ?></td>
                        <td><a href="formEditarEmpleado.html"><i class="fa-solid fa-pencil"></i></a></td>
